...
@section('title','E-SHOP || Series Edit')
@section('main-content')

<div class="card">
    <h5 class="card-header">Edit Series</h5>
    <div class="card-body">
      <form method="post" action="{{route('series.update',$series->id)}}">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="Enter title"  value="{{$series->title}}" class="form-control">
        @error('title')
